...
model_1s_clmm <- clmm(source_trustworthiness ~ item_type * phase * treatment + (1 + item_type + phase| ID) + (1 | link_number),
  data = data_prepost,
  link = "logit", Hess = TRUE)

model_2s_clmm <- clmm(source_trustworthiness ~ item_type * phase * treatment + (1 + item_type + phase| ID) + (1 | link_number),
  data = data_prefollow,
  link = "logit",
  Hess = TRUE)


model_1c_clmm <- clmm(claim_credibility ~ item_type * phase * treatment + (1 + item_type + phase| ID) + (1 | link_number),
  data = data_prepost,
  link = "logit",
  Hess = TRUE)

model_2c_clmm <- clmm(  claim_credibility ~ item_type * phase * treatment + (1 + item_type + phase| ID) + (1 | link_number),
  data = data_prefollow,
  link = "logit",
  Hess = TRUE)
